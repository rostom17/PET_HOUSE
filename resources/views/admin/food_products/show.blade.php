...
@section('title', 'Food Product Details')

@section('content')
<div class="container">
    <h2><i class="fas fa-bone"></i> Food Product Details</h2>
    @if(isset($product))
        <div style="display: flex; gap: 30px; align-items: flex-start; flex-wrap: wrap; margin-bottom: 24px;">
            ...
            <div style="flex: 1;">
                ...
                <div class="detail-box">
                    ...
                    <span class="detail-value">{{ $product->food_type }}</span>
                </div>
                <div class="detail-box">
        ...
        <div class="actions">
            ...
            <a href="{{ route('admin.food.products.edit', $product) }}" class="btn btn-primary">
