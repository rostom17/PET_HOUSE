...
@section('content')
<div class="container">
    <h2><i class="fas fa-edit"></i> Edit Food Product</h2>
    @if(isset($product))
    <form method="POST" action="{{ route('admin.food.products.update', $product) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="text" name="food_type" value="{{ old('food_type', $product->food_type) }}" required>
        </div>
        <div class="form-group">
            <label>Weight</label>
